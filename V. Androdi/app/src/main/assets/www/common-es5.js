(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppComponentsListasListasComponentHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-list>\n\n    <ion-item-sliding *ngFor=\"let lista of pendienteService.listas | filtroCompleto:terminados\">\n        <ion-item detail (click)=\"listaSeleccionada(lista)\">\n            <ion-label>{{lista.titulo}}</ion-label>\n            <ion-note slot=\"end\" color=\"tertiary\">{{lista.items.length}}</ion-note>\n        </ion-item>\n\n        <ion-item-options side=\"start\">\n            <ion-item-option (click)=\"editarLista(lista)\" color=\"primary\">\n                <ion-icon name=\"create-outline\" slot=\"icon-only\"></ion-icon>\n            </ion-item-option>\n        </ion-item-options>\n\n        <ion-item-options side=\"end\">\n            <ion-item-option (click)=\"borrarLista(lista)\" color=\"danger\">\n                <ion-icon name=\"close-circle-outline\" slot=\"icon-only\"></ion-icon>\n            </ion-item-option>\n        </ion-item-options>\n    </ion-item-sliding>\n\n\n\n</ion-list>";
      /***/
    },
    ...
    function srcAppComponentsListasListasComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_pendientes_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ListasComponent = /*#__PURE__*/function () {
        function ListasComponent(pendienteService, router, alert) {
        ...
        _createClass(ListasComponent, [{
          ...
          value: function borrarLista(lista) {
            this.pendienteService.borrarLista(lista);
          }
        }, {
          key: "editarLista",
                      ...
                      return this.alert.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler(data) {
                            ...
                            _this.pendienteService.guardarStorage();
      ...
      ListasComponent.ctorParameters = function () {
        return [{
          type: _services_pendientes_service__WEBPACK_IMPORTED_MODULE_2__["PendientesService"]
        }, {
    ...
    /***/
    "./src/app/pipes/filtro-completo.pipe.ts":
    /*!***********************************************!*\
      !*** ./src/app/pipes/filtro-completo.pipe.ts ***!
      \***********************************************/

    /*! exports provided: FiltroCompletoPipe */

    /***/
    function srcAppPipesFiltroCompletoPipeTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FiltroCompletoPipe", function () {
        return FiltroCompletoPipe;
      });
      /* harmony import */
      ...
      var FiltroCompletoPipe = /*#__PURE__*/function () {
        function FiltroCompletoPipe() {
          _classCallCheck(this, FiltroCompletoPipe);
        }

        _createClass(FiltroCompletoPipe, [{
          key: "transform",
          value: function transform(listas) {
            var finalizada = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
            return listas.filter(function (lista) {
              return lista.completada === finalizada;
            });
          }
        }]);
      ...
      FiltroCompletoPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'filtroCompleto',
        pure: false
      })], FiltroCompletoPipe);
      /***/
    ...
    function srcAppPipesPipesModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _filtro_completo_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./filtro-completo.pipe */
      "./src/app/pipes/filtro-completo.pipe.ts");
      ...
      PipesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_filtro_completo_pipe__WEBPACK_IMPORTED_MODULE_2__["FiltroCompletoPipe"]],
        exports: [_filtro_completo_pipe__WEBPACK_IMPORTED_MODULE_2__["FiltroCompletoPipe"]]
      })], PipesModule);
      /***/
    },
    ...
    /*! exports provided: PendientesService */

    /***/
    function srcAppServicesPendientesServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PendientesService", function () {
      ...
      var PendientesService = /*#__PURE__*/function () {
        function PendientesService() {
          _classCallCheck(this, PendientesService);

          this.listas = [];
          this.cargarStorage();
        }

        _createClass(PendientesService, [{
          key: "crearLista",
      ...
      PendientesService.ctorParameters = function () {
        return [];
      };

      PendientesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], PendientesService);
      /***/
    }
